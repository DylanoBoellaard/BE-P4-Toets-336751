-- Step: 01
-- Goal: Create a new database mvc-2209b-P4-Toets
-- **********************************************************************************
...
-- Use database mvc-2209b-P4-Toets
...
-- Stap 04, Create Examinator table
...
-- Stap 05, Fill Examinator table with data
...
-- Stap 06, Create ExamenPerExaminator table
...
-- Stap 07, Fill ExamenPerExaminator table with data
